...
from comet.characteristic_function import CharacteristicFunction
from comet.problem_space import ProblemSpace
...
def infer(
    ...
    total_activation = sum(
        rule.activation_degree for rle in activated_rules
    )
